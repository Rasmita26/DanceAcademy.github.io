<%@ Page Title="" Language="C#" MasterPageFile="~/Student.master" AutoEventWireup="true" CodeFile="Event1.aspx.cs" Inherits="Event1" %>
    ...
    <div>
        ...
        <Columns> 
            <asp:BoundField DataField = "eventId" HeaderText = "Event Id" /> 
             ...
             <asp:CommandField HeaderText="TicketBokking" ShowHeader="True" ShowSelectButton="True" SelectText="TicketBooking" />
